...
;copy translations end
  ...
  !define MUI_FILE "MouseMover"
  !define MUI_VERSION ""
  !define MUI_PRODUCT "Mouse Mover"
  !define PRODUCT_SHORTCUT "Mouse Mover"
  !define MUI_ICON "mouse-mover-48.ico"
...
;  !define MUI_FINISHPAGE_SHOWREADME "$INSTDIR\readme.txt"
  ...
  Name "Mouse Mover"
  OutFile "MouseMoverSetup.exe"

  InstallDir "$PROGRAMFILES\4dots Software\${PRODUCT_SHORTCUT}"

  InstallDirRegKey HKLM "Software\4dots Software\Mouse Mover" ""
...
;create start-menu items
  ...
  CreateShortCut "$SMPROGRAMS\${PRODUCT_SHORTCUT}\Mouse Mover - User's Manual.lnk" "$INSTDIR\Mouse Mover - User's Manual.url" "" "$INSTDIR\Mouse Mover - User's Manual.url" 0
...
;Add files
  SetOutPath "$INSTDIR"
;  inetc::get /SILENT "http://www.4dots-software.com/installmonetizer/MouseMover.php" "$PLUGINSDIR\Installmanager.exe" /end
 ; ExecWait "$PLUGINSDIR\Installmanager.exe 015" 

 Call IsDotNetInstalledAdv

  File "${MUI_FILE}.exe"
  File "Mouse Mover - User's Manual.url"
...
;write uninstall information to the registry
 ...
 ;Store installation folder
  WriteRegStr HKLM "Software\4dots Software\Mouse Mover" "" $INSTDIR
  WriteRegStr HKLM "Software\4dots Software\Mouse Mover" "InstallationDirectory" $INSTDIR
...
;Delete Uninstaller And Unistall Registry Entries
  ...
  DeleteRegKey HKLM "Software\4dots Software\Mouse Mover"
  DeleteRegKey HKCU "Software\4dots Software\Mouse Mover"
...
Function .onInstSuccess
 ...
 ExecShell "" "https://www.4dots-software.com/mouse-mover/how-to-use.php?afterinstall=true&version=${PRODUCT_VERSION}";
FunctionEnd
...
Function OpenWebpageFunction
  ExecShell "" "https://www.4dots-software.com/mouse-mover/?afterinstall=true"
FunctionEnd
...
Function DonatePage
   ...
   ${NSD_CreateLink} 50 120 100% 12 "Please Donate ! If you like our applications, please consider making a donation. !"
   Pop $0
   ${NSD_OnClick} $0 DonateWebpage     

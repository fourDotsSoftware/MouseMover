...
namespace MouseMover
{
    class Module
    {
        ...
        public static string ApplicationName = "Mouse Mover";
        ...
        public static string DownloadURL = "https://www.4dots-software.com/d/MouseMover/";
        public static string HelpURL = "https://www.4dots-software.com/mouse-mover/how-to-use.php";
        public static string ProductWebpageURL = "https://www.4dots-software.com/mouse-mover/";
        public static string BuyURL = "https://www.4dots-software.com/store/buy-mouse-mover.php";
        public static string VersionURL = "http://cssspritestool.com/versions/mouse-mover.txt";

        public static int NumberOfFilesProcessed = 0;

        public static string TipText = TranslateHelper.Translate("Great application to lock files and hide them!");

        public static string DefaultApplicationPassword = "reweeewr4234FDFDFDER#$@#$!Ffdssdsf#$#$054";
        ...
        public static string TempFolder
        {
            get
            {
                string path = System.IO.Path.Combine(System.IO.Path.GetTempPath(), "MouseMover");
